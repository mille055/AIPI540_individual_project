...
model_paths2 = {'cnn': '../../models/pixel_model_041623.pth', 'nlp': '../../models/text_model20230415.st', 'meta': '../../models/meta_04152023.skl', 'fusion': '../../models/fusion_model_weights042423.pth', 'fusion_no_nlp': '../../models/fusion_model_weights_no_nlp042423.pth', 'scaler': '../../models/metadata_scaler.pkl' }
